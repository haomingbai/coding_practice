...
bool operator<(const uint_5000& a,const uint_5000& b){
	int i=0;
	while(a.data[i]==0&&b.data[i]==0&&i<2500){
		i++;
	}
	if(i==2500) return 0;
...
uint_5000 factorial(uint_5000 x){
	uint_5000 res="1";
	for(uint_5000 i="1";i<=x;i=i+"1"){
		res=res*i;
	}
	return res;
}

uint_5000::uint_5000(long long y){
	long long x=y;
	for(int i=2499;i>0||x;i--){
		data[i]=x%100;
		x/=100;
	}
}
